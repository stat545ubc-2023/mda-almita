...
For this task I will have to split up the `genres` for each game entry, as some of them have different genres assigned to them. I will do the same to `steamspy_tags` to compare, as I believe they are more descriptive.
...
```
Now to get the number of occurrences of each categorical value:
