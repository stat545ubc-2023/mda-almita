...
*Note: The following graph corresponds to the chosen graphing task, however it's not the graph I want to conclude this section with.*
...
The p-value indicates that there is a non-zero correlation between `steam_score` and `metacritic`, and the R-squared value indicates that the correlation is a weak and positive.
