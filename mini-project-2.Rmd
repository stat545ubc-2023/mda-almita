...
```{r}
pal3 = c("#0952d9", "#4d91e5", "#002369", "#4b367b", "#7e4367", "#961759", "#8d0046", "#dc003f", "#e60a7b")
```
...
steam_rq3 %>%
  ...
  geom_jitter(aes(size = number_ratings), 
              stroke = 0, 
              alpha = 0.8) +
  scale_color_manual(values = pal3, name = "Review") +
...
```{r}
steam_rq3 %>%
  group_by(fct_relevel(review, review_labels)) %>%
...
```{r}
pal4 <- c("#004B59", "#017692", "#2bd4cb", "#a7d5b2", "#92a5df", "#EBA3EA", "#F85F6F", "#ff7536", "#e7106c")
```
...
steam_rq4 %>%
  ...
  geom_jitter(data = steam_rq4 %>% select(-review), aes(group = review2, size = number_ratings), color="#DCD3C5", width = 0.1, alpha=0.4) +
  geom_jitter(aes(color = review, size = number_ratings), width = 0.1) +
  scale_size(breaks = c(20, 1000, 10000, 100000, 1000000),
             range = c(0.4, 13), 
             labels = scales::label_comma(),
             name="Number of ratings") +
